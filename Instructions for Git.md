...
Воспользуемся  крупнейшим веб-сервисом для хостинга IT-проектов и их совместной разработки - [Github.com](https://github.com/).
...
**Важно**: Команда `git pull` является составной командой и выполяет 2 действия.
